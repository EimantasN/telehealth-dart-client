...
class CreateReminderCmdCustom {
  ...
  @override
  String toString() => 'CreateReminderCmdCustom[count=$count, time=$time, daily=$daily, weekly=$weekly, monthly=$monthly, yearly=$yearly, selections=$selections, times=$times]';
