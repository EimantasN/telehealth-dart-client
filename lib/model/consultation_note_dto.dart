...
class ConsultationNoteDto {
  ...
  /// Returns a new [ConsultationNoteDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ConsultationNoteDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ConsultationNoteDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ConsultationNoteDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ConsultationNoteDto> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ConsultationNoteDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ConsultationNoteDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ConsultationNoteDto> mapFromJson(dynamic json) {
    final map = <String, ConsultationNoteDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConsultationNoteDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ConsultationNoteDto-objects as value to a dart map
  static Map<String, List<ConsultationNoteDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ConsultationNoteDto>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ConsultationNoteDto.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
